...
working_proverbs = proverbs.copy()
working_variants = variants.copy()

random.shuffle(working_proverbs)
random.shuffle(working_variants)

results = []
max_proverbs = min(num_proverbs, len(proverbs), len(variants))

for i in range(max_proverbs):
    new_proverb = working_proverbs[i].replace("Ум", working_variants[i].capitalize())
    new_proverb = new_proverb.replace("ум", working_variants[i].lower())
